    ...
    <div class="row mt-rs-4">
        <div class="col-sm-4 mb-4 mb-xl-0">
            <div class="d-lg-flex align-items-center">
                <div>
                    <h3 class="text-dark font-weight-bold mb-2">Edit Lowongan Lowongan: <u>{{ $datalowongan->nama }}</u></h3>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body collapse show">
                        <div class="row">
                            <div class="col-md-9">
                                <h3 class="card-title">Informasi Lowongan Pekerjaan <u>{{ $datalowongan->nama }}</u></h3>
                                <h6 class="card-subtitle">Data Informasi dan Deskripsi</h6>
                            </div>
                        </div>
                        <form action="/company/lowongan-kerja/update/{{ $datalowongan->nama }}" method="POST"
                            ...
                            <div class="row pdt-20">
                                ...
                                <div class="col-md-8 pdt-6">
                                    <input type="text" name="nama" class="form-control font-weight-normal"
                                        placeholder="Posisi / Judul Lowongan Pekerjaan" value="{{ $datalowongan->nama }}">
                                </div>
                            </div>
                            <div class="row pdt-20">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8 pdt-6">
                                    <input type="text" name="gaji" class="form-control font-weight-normal"
                                        placeholder="Contoh: 1 juta - 2 juta" value="{{ $datalowongan->gaji }}">
                                </div>
                            </div>
                            <div class="row mrt-6">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8 pdt-6">
                                    <input type="text" name="lokasi" class="form-control font-weight-normal"
                                        placeholder="Daerah, Kota atau Kabupatens" value="{{ $datalowongan->lokasi }}">
                                </div>
                            </div>
                            <div class="row pdt-20">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-select" id="inputGroupSelect01" name="id_kategoti_pekerjaan">
                                            ...
                                            @foreach ($category as $item)
                                                <option value="{{ $item->id }}" {{ $datalowongan->id_kategoti_pekerjaan == $item->id ? 'selected':'' }}>{{ $item->nama_kategori }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <input id="deskripsi" placeholder="Tentang diri anda"
                                        class="form-control font-weight-normal" type="hidden" name="deskripsi"
                                         value="{{ $datalowongan->deskripsi_pekerjaan }}">
