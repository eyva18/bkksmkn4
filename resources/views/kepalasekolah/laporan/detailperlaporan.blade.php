    ...
    <div class="row mt-rs-4">
        <div class="col-sm-4 mb-4 mb-xl-0">
            <div class="d-lg-flex align-items-center">
                <div>
                    <h3 class="text-dark font-weight-bold mb-2">Laporan Detail @if ($tahunlulusdata != null) Tahun: <u>{{ $tahunlulusdata->tahun_lulus ?? ''}} </u>
                        @endif - <u>{{ $jurusandata->jurusan }}</u> </h3>
    ...
    <div class="row-12 mt-4">
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-12 mt-4">
                <div class="card">
                    <div class="card-body">
                        <a href="/kepala-sekolah/report/yearly/{{ $tahunlulusdata->tahun_lulus ?? ''}}/jurusan/{{ $jurusandata->id }}/export" class="btn btn-lg btn-primary"><i class="fas fa-share-square"></i> Export</a>
