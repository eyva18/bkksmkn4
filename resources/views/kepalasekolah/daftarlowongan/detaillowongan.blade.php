            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-6 mb-3">
                    <div class="card border-top-blue-300">
                        ...
                        <a href="/kepala-sekolah/perusahaan/profile/{{ $datalowongan->dudi->nama }}" class="btn btn-primary">Detail Perusahaan</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <li class="media d-flex align-items-start company-show">
                                ...
                                <div class="media-body">
                                    <ul class="list-unstyled">
                                        ...
                                        <li><i class="mdi mdi-map-marker color-23"></i> <span class="mrl-5 text-black">{{ $item->lokasi }}</span></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <a href="/kepala-sekolah/lowongan-kerja/detail/{{ $item->nama }}" class="btn btn-primary">Detail Lowongan</a>
                </div>
            </div>
            @endforeach
        </div>
