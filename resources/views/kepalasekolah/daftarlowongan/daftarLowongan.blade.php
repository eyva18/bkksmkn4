            ...
            <div class="col-sm-12 mr">
                <div class="card">
                    <div class="card-body collapse show">
                        ...
                        <form action="/kepala-sekolah/lowongan-kerja/search+" method="get">
                            @csrf
                            <div class="row">
            ...
            @foreach ($datadudi as $item)
                <div class="col-md-6 col-lg-4">
                    <div class="card border-top-blue-300 mb-3">
                        ...
                        <a href="/kepala-sekolah/perusahaan/profile/{{ $item->nama }}" class="btn btn-primary">Detail Perusahaan</a>
                    </div>
                </div>
            @endforeach
        </div>
