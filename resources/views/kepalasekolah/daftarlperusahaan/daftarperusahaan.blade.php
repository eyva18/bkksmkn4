            ...
            <div class="col-sm-12 mr">
                <div class="card">
                    <div class="card-body collapse show">
                        ...
                        <form action="/kepala-sekolah/daftar-perusahaan/search+" method="get">
                            @csrf
            ...
            @foreach ($perusahaan as $dataperusahaan)
                <div class="col-md-6 col-lg-4">
                    <div class="card border-top-black-300 mt-5">
                        ...
                        <a href="/kepala-sekolah/perusahaan/profile/{{ $dataperusahaan->nama }}" class="btn btn-primary">Profile
                            Perusahaan</a>
                    </div>
                </div>
            @endforeach
            ...
            @foreach ($lowongan as $datalowongan)
                <div class="col-lg-4 col-md-6">
                    <div class="card border-top-black-300 mb-3">
                        ...
                        <a href="/kepala-sekolah/lowongan-kerja/detail/{{ $datalowongan->nama }}" class="btn btn-primary">Detail
                            Lowongan</a>
                    </div>
                </div>
            @endforeach
