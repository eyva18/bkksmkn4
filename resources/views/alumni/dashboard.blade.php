                    ...
                    <div class="card bg-dark text-light" style="border-left: 15px solid white">
                        ...
                        <div class="card-body">
                            @foreach ($dataPendidikan as $data)
                                <h3 class="card-text fw-bolder">{{ $data->nama_instansi }} <button class="icon-button-modal" data-bs-toggle="modal" data-bs-target="#editpendidikan{{ $data->id }}"><i class="mdi mdi-pencil text-light fs-4"></i></button></h3>
                                <p>{{ $data->Pendidikan->jenis_pendidikan }} - Skor : {{ $data->nilai_rata_rata }} <br>Lulus Tahun : {{ $data->tahun_akhir_pendidikan }}</p>
                                <h3><button type="button" class="icon-button-modal" data-bs-toggle="modal" data-bs-target="#deletePendidikanmodal{{ $data->id ??'-' }}"><i class="mdi mdi-delete text-danger fs-4"></i></button></h3>
                                <hr>

                                {{-- Modal Edit Riwayat Pendidikan --}}        
                                <div class="modal fade text-dark" id="editpendidikan{{ $data->id }}" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="example-input-large" name="nama_instansi" class="form-control @error('nama_instansi') is-invalid @enderror" value="{{ old('nama_instansi', $data->nama_instansi) }}">
                                                                @error('nama_instansi')
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="example-input-large" name="nilai_rata_rata" class="form-control @error('nilai_rata_rata') is-invalid @enderror" value="{{ old('nilai_rata_rata', $data->nilai_rata_rata) }}">
                                ...
                                {{-- Modal Delete Start --}}
                                <div id="deletePendidikanmodal{{ $data->id ??'-' }}" class="modal fade" tabindex="-1" role="dialog"
                                    aria-hidden="true">
                    ...
                    <div class="card bg-dark text-light" style="border-left: 15px solid white">
                        ...
                        <div class="card-body">
                            @foreach ($dataPekerjaan as $data)
                                <h3 class="card-text fw-bold">{{ $data->bidang }} <button class="icon-button-modal" data-bs-toggle="modal" data-bs-target="#editpekerjaan{{ $data->id }}"><i class="mdi mdi-pencil text-light fs-4"></i></button></h3>
                                ...
                                <h3><button type="button" class="icon-button-modal" data-bs-toggle="modal" data-bs-target="#deletePekerjaanModal{{ $data->id ??'-' }}"><i class="mdi mdi-delete text-danger fs-4"></i></button></h3>
                                <hr>

                                {{-- Modal Update Pengalaman Kerja --}}
                                <div class="modal fade text-dark" id="editpekerjaan{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                            ...
                            @foreach ($dataSertifikasi as $data)
                                <div class="row">
                                    ...
                                    <div class="col-6-md p-3">
                                        <a href="{{ $data->link_sertifikasi }}" style="text-decoration: none"><p class="fw-bold fs-5">{{ $data->nama_sertifikasi }}</p></a>
                                    ...
                                    <div class="col-12-md my-2 d-flex justify-content-between">
                                        <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editsertifikat{{ $data->id }}"><i class="mdi mdi-pencil text-dark"></i></button>
                                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deletesertifikat{{ $data->id }}"><i class="mdi mdi-delete text-dark"></i></button>
                                    </div>
                                    <hr>
                                </div>
                                ...
                                <div class="modal fade" id="editsertifikat{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form action="/profile/sertifikasi/update" method="post" enctype="multipart/form-data">
                                                @method('post')
                                                @csrf
                                                <input type="hidden" name="id" value="{{ $data->id }}">
                                                <div class="modal-body">
                ...
                <div class="col-sm-12 col-md-6 grid-margin d-flex stretch-card">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <button class="icon-button-modal" data-bs-toggle="modal" data-bs-target="#lombaModal"><i class="mdi mdi-plus text-primary fs-5"></i></button>
                        </div>
                        <div class="card-body">
                            @foreach ($dataSertifikasiLomba as $data)
                                <div class="row">
                                    ...
                                    <div class="col-12-md my-2 d-flex justify-content-between">
                                        <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editsertifikatlomba{{ $data->id }}"><i class="mdi mdi-pencil text-dark"></i></button>
                                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deletesertifikatlomba{{ $data->id }}"><i class="mdi mdi-delete text-dark"></i></button>
                                    </div>
                                    <hr>
                                </div>
                                ...
                                <div class="modal fade" id="editsertifikatlomba{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form action="/profile/sertifikasilomba/update" method="post" enctype="multipart/form-data">
                                                @method('post')
                                                @csrf
                                                <input type="hidden" name="id" value="{{ $data->id }}">
                                                <div class="modal-body">
