                            ...
                            <div class="col-md-4">
                                <select class="form-select full-size-width" id="inputGroupSelect01" name="idtahunlulus">
                                    <option selected="">Spesialis Pekerjaan</option>
                                                                    <option value="Category Pekerjaan 1">Category Pekerjaan 1</option>
                                                                    <option value="Category Pekerjaan 2">Category Pekerjaan 2</option>
                                                                    <option value="Category Pekerjaan 3">Category Pekerjaan 3</option>
                                                                </select>
                            </div>
                            <div class="col-md-4">
                                    <input type="text" id="" name="nama_alumni" class="form-control" placeholder="Kata Kunci Lowongan" style="height: 40px">
                            </div>
                            <div class="col-md-4">
                        ...
                        <ul class="list-unstyled">
                            <li class="media d-flex align-items-start company-show">
                                ...
                                <div class="media-body">
                                    <ul class="list-unstyled">
                                        <li><i class="mdi mdi-hospital-building color-23"></i> <span class="mrl-5 text-black">Stella Toy</span></li>
                                        <li><i class="mdi mdi-clipboard-outline color-23"></i> <span class="mrl-5 text-black">Test1</span></li>
                                        <li><i class="mdi mdi-calendar color-23"></i> <span class="mrl-5 text-black">2023-04-27</span></li>
                                        <li><i class="mdi mdi-map-marker color-23"></i> <span class="mrl-5 text-black">awdawdadw</span></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="col-md-12 p-4">
                        ...
                        <ul class="list-unstyled">
                            <li class="media d-flex align-items-start company-show">
                                ...
                                <div class="media-body">
                                    <ul class="list-unstyled">
                                        <li><i class="mdi mdi-newspaper color-23"></i> <span class="mrl-5 text-black">0 Lowongan Aktif </span></li>
                                        <li><i class="mdi mdi-clipboard-text  color-23"></i> <span class="mrl-5 text-black">Hotel Dan Pariwisata</span></li>
                                        <li><i class="mdi mdi-phone color-23"></i> <span class="mrl-5 text-black">081251043737</span></li>
                                        <li><i class="mdi mdi-map-marker  color-23"></i> <span class="mrl-5 text-black">Banjarmasin</span></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <a href="javascript:void(0)" class="btn btn-primary">Detail Perusahaan</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card border-top-blue-300 mt-5">
